...
(function() {
  jQuery.fn.offset_of_window = function() {
    var jqw, off_bottom, off_left, off_right, off_top, offset, window_scroll_left, window_scroll_top;
    offset = this.offset();
    off_top = offset.top;
  ...
  jQuery.fn.is_in_screen = function() {
    ...
    jqw = jQuery(window);
    if (oow.top > jqw.height()) {
      return false;
    }
    if (oow.bottom > jqw.height()) {
      return false;
    }
    if (oow.left > jqw.width()) {
      return false;
    }
    if (oow.right > jqw.width()) {
      return false;
    }
    return true;
  };
  ...
  window.Util = {
     ...
     */
    spacing_grid_data: function(length, grid_count, spacing) {
      var i, side_length;
      if (grid_count == null) {
        grid_count = 1;
      }
      ...
      return {
        ...
        positions: (function() {
          var j, ref, results;
          results = [];
          for (i = j = 0, ref = grid_count; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
            results.push(i * (side_length + spacing));
          }
          return results;
        })()
      };
     ...
     */
    array_init: function(length, func) {
      var i, j, ref, results;
      if (length == null) {
        length = 0;
      }
